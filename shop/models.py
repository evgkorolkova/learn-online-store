...
class Writer(models.Model):
    ...
    description = models.TextField("Информация об авторе", blank=True, default="")
    class Meta:
        verbose_name = "Автор"
...
class Product(models.Model):
    ...
    writer = models.ManyToManyField(Writer, verbose_name="Писатель", related_name="writer_product")
    url = models.SlugField(max_length=200, unique=True)
